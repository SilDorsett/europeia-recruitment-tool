...
class Bot(commands.Bot):
    ...
    async def create_recruitment_response(self, user: discord.User, channel_id: int):
        ...
        view.add_item(discord.ui.Button(label="Open Telegram", style=discord.ButtonStyle.link,
                                        url=f"https://www.nationstates.net/page=compose_telegram?tgto={','.join(nations)}&message=%25{recruiter.template}%25&generated_by=AspertaRecruitmentTool__by_UPC__usedBy_{configInstance.data.operator}"))
